                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=> {e.stopPropagation}} className="text-emerald-500">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-indigo-100 border border-emerald-300 md:w-[80px] w-[64px] h-[34px] rounded text-emerald-600 font-medium cursor-pointer" onClick={() => addToCart(product._id)} >
